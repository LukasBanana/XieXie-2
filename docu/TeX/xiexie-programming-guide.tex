...
\subsubsection{\texttt{switch} Branch}
...
\begin{enumerate}
	...
	\item Return type of all member procedures is analyzed.
...
\Rotatebox{90}{
\begin{tabular}[ht]{
	| p{0.07 \textheight} | p{0.093 \textheight} | p{0.077 \textheight} | p{0.34 \textheight} | p{0.23 \textheight} |
}
	\hline
...
\Rotatebox{90}{
\begin{tabular}[ht]{
	| p{0.07 \textheight} | p{0.093 \textheight} | p{0.077 \textheight} | p{0.34 \textheight} | p{0.234 \textheight} |
}
	\hline
...
\begin{tabular}[ht]{
	| p{0.07 \textheight} | p{0.093 \textheight} | p{0.077 \textheight} | p{0.077 \textheight}
	| p{0.26 \textheight} | p{0.185 \textheight} |
}
	\hline
...
\Rotatebox{90}{
\begin{tabular}[ht]{
	| p{0.07 \textheight} | p{0.093 \textheight} | p{0.422 \textheight} | p{0.2 \textheight} |
}
	\hline
...
\Rotatebox{90}{
\begin{tabular}[ht]{
	| p{0.07 \textheight} | p{0.093 \textheight} | p{0.16 \textheight} | p{0.26 \textheight} | p{0.24 \textheight} |
}
	\hline
...
; void proc() { ... }
proc:
  ADD $sp, $sp, 8   ; Allocate memory on the stack ...
                      ; ... for two words (2*4 bytes)
  MOV $r0, 42       ; Store value 42 in register $r0
  STW $r0, ($lb) 8  ; Store register $r0 in local scope ...
                      ; ... at first position (after dynamic link)
  ADD $r0, $r0, 10  ; Increment value of register $r0
  STW $r0, ($lb) 12 ; Store register $r0 in local scope ...
                      ; ... at second position
  ...
\end{lstlisting}
