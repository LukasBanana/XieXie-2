...
and is pronounced for instance ``Sh-eh sh-eh''. To make a long story short, 
...
Then I remembered me to the Chinese word ``Xi\`exie'' which means ``Thanks'' in English and it sounded a little
...
There are many great programming languages out there. Some produce faster code than others, but for that others
...
which forces you to better readability it \python. Actually a great principle, but with \xiexie you have complete freedom.
...
never begin with '[['. They may end with ']]' this is not important for the parser.
...
are always implicitly imported, because they are `internal' classes the compiler knows generally.
