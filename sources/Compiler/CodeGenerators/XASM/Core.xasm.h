...
"	ldw $r2, ($cf) 12	; load rhs.size\n"
"	cmp $r2, 1			; check: rhs.size <= 1\n"
"	jle .end\n"
"	\n"
"	; determine new string size\n"
"	ldw $r1, ($xr) 12	; load this.size\n"
"	add $r2, $r2, $r1	; calculate size := this.size + rhs.size\n"
"	sub $r2, $r2, 2		; subtract 2 from size because of both null terminators\n"
"	\n"
"	; resize this string\n"
"	push $r0			; store rhs\n"
"	push $r2\n"
